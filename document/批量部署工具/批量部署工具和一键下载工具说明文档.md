...
说明：部署工具部署BiShengJDK8 和 BiShengJDK17时，均使用服务器内部自带的 `update-alternatives` 命令进行配置。默认BiShengJDK8版本优先。
...
直接执行该命令即可下载 **GCCforOpenEuler**，**BiShengCompiler**，**BiShengJDK8**，**BiShengJDK17**，**lkp-tests** 组件。
