...
cp -rf  "${current_dir}"/build/install_dependency/dist/*  "${current_dir}"/build/dekvit-pipeline-${tag}/linux
cp -rf  "${current_dir}"/build/download_dependency/dist/*  "${current_dir}"/build/dekvit-pipeline-${tag}/linux
