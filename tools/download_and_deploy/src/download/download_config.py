...
CompatibilityTesting = {
    ...
    "file": "https://gitee.com/openeuler/devkit-pipeline/releases/download/v1.0.2/compatibility_testing.tar.gz",
    "file_size": "76451308",
}

DevKitTester = {
    "component_name": "DevKitTester",
    "file": "https://gitee.com/openeuler/devkit-pipeline/releases/download/v1.0.2/devkit_tester.tar.gz",
    "file_size": "36153017",
}

A_FOT = {
    "component_name": "A-FOT",
    "file": "https://gitee.com/openeuler/devkit-pipeline/releases/download/v1.0.2/a-fot.tar.gz",
    "file_size": "15740",
}

DevKitWeb = {
    "component_name": "DevKitWeb",
    "file": "https://mirrors.huaweicloud.com/kunpeng/archive/DevKit/Packages/Kunpeng_DevKit/DevKit-All-24.0.RC2-Linux-Kunpeng.tar.gz",
    "file_size": "1028773350",
}

DevKitCLI = {
    "component_name": "DevKitCLI",
    "file": "https://mirrors.huaweicloud.com/kunpeng/archive/DevKit/Packages/Kunpeng_DevKit/DevKit-CLI-24.0.RC2-Linux-Kunpeng.tar.gz",
    "file_size": "437515661",
}
