...
CompatibilityTesting = {
    ...
    "file": "https://gitee.com/openeuler/devkit-pipeline/releases/download/v1.0.3/compatibility_testing.tar.gz",
    "file_size": "76451308",
}

DevKitTester = {
    "component_name": "DevKitTester",
    "file": "https://gitee.com/openeuler/devkit-pipeline/releases/download/v1.0.3/devkit_tester.tar.gz",
    "file_size": "36153017",
}

A_FOT = {
    "component_name": "A-FOT",
    "file": "https://gitee.com/openeuler/devkit-pipeline/releases/download/v1.0.3/a-fot.tar.gz",
    "file_size": "15740",
}
